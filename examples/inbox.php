...
$id=$_SESSION['usrnm'];
$sql=mysql_query("SELECT * FROM mails where rec_id='$id'");


	echo "<table border='1' width='800px' align='center'  class='w3-table-all w3-hoverable'>";
...
while(list($mid,$rid,$sid,$s,$m,$a,$md)=mysql_fetch_array($sql))
{
	...
	echo "<td>".$sid."</td>";
	echo "<td><a href='mail.php?coninb=$mid'>".$s."</a></td>";
	$_SESSION['id']=$mid;
	echo "<td>".$a."</td>";
	echo "<td>".$md."</td>";
	echo "</tr>";		
...
if(isset($_REQUEST["search"])){
    ...
    $sql = "SELECT * FROM mails WHERE sen_id LIKE ?";  
